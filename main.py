...
import sys
import math
from crudl.init_csv import check_dataFolder
...
class QWindow(QMainWindow) :
    def __init__(self):
        ...
        # main_layout.addWidget(myTestBtn)
    ...
    def animationSeq(self, what) :
        if what == "add" :
            ...
            self.feedback.setStyleSheet("max-width: 100px; max-height: 80px;color:white;background-color: green;border-radius:12px; font-weight: bold")
        elif what == "edit" :
            self.feedback.setText('edited')
            self.feedback.setStyleSheet("max-width: 100px; max-height: 80px; color:white;background-color: orange;border-radius:12px; font-weight: bold")
        elif what == "delete" :
            self.feedback.setText('deleted')
            self.feedback.setStyleSheet("max-width: 100px; max-height: 80px; color:white;background-color: red;border-radius:12px; font-weight: bold")
